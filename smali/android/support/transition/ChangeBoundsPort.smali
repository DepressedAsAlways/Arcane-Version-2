...
.method public final a(Landroid/view/ViewGroup;Landroid/support/transition/TransitionValues;Landroid/support/transition/TransitionValues;)Landroid/animation/Animator;
    ...
    iget-boolean v0, v0, Landroid/support/transition/ChangeBoundsPort;->b:Z
    ...
    .line 198
    new-instance v3, Landroid/support/transition/ChangeBoundsPort$1;

    move-object/from16 v0, p0

    invoke-direct {v3, v0}, Landroid/support/transition/ChangeBoundsPort$1;-><init>(Landroid/support/transition/ChangeBoundsPort;)V

    .line 224
    move-object/from16 v0, p0

    invoke-virtual {v0, v3}, Landroid/support/transition/ChangeBoundsPort;->a(Landroid/support/transition/TransitionPort$TransitionListener;)Landroid/support/transition/TransitionPort;
    ...
    .line 278
    new-instance v3, Landroid/support/transition/ChangeBoundsPort$2;

    move-object/from16 v0, p0

    invoke-direct {v3, v0}, Landroid/support/transition/ChangeBoundsPort$2;-><init>(Landroid/support/transition/ChangeBoundsPort;)V
    ...
    .line 306
    :cond_1f
    new-instance v3, Landroid/support/transition/ChangeBoundsPort$3;

    move-object/from16 v0, p0

    invoke-direct {v3, v0}, Landroid/support/transition/ChangeBoundsPort$3;-><init>(Landroid/support/transition/ChangeBoundsPort;)V
    ...
    .line 329
    invoke-static/range {p1 .. p1}, Landroid/support/transition/ViewOverlay;->c(Landroid/view/View;)Landroid/support/transition/ViewOverlay;
