...
.method constructor <init>(Ljava/io/File;JLokhttp3/internal/c/a;)V
    ...
    invoke-static/range {v0 .. v5}, Lokhttp3/internal/cache/DiskLruCache;->create(Lokhttp3/internal/c/a;Ljava/io/File;IIJ)Lokhttp3/internal/cache/DiskLruCache;
...
.method final get(Lokhttp3/Request;)Lokhttp3/y;
    ...
    invoke-virtual {v2, v1}, Lokhttp3/internal/cache/DiskLruCache;->get(Ljava/lang/String;)Lokhttp3/internal/cache/DiskLruCache$c;
    :try_end_0
    ...
    invoke-virtual {v1, v3}, Lokhttp3/internal/cache/DiskLruCache$c;->a(I)Lokio/s;
    ...
    .line 211
    invoke-virtual {v2, v1}, Lokhttp3/Cache$c;->a(Lokhttp3/internal/cache/DiskLruCache$c;)Lokhttp3/y;

    move-result-object v1

    .line 213
    invoke-virtual {v2, p1, v1}, Lokhttp3/Cache$c;->a(Lokhttp3/Request;Lokhttp3/y;)Z
    ...
    .line 1177
    iget-object v1, v1, Lokhttp3/y;->g:Lokhttp3/z;
...
.method final put(Lokhttp3/y;)Lokhttp3/internal/cache/CacheRequest;
    ...
    .line 3086
    iget-object v2, p1, Lokhttp3/y;->a:Lokhttp3/Request;
    ...
    invoke-static {v2}, Lokhttp3/internal/a/f;->a(Ljava/lang/String;)Z
    ...
    invoke-direct {v1, p1}, Lokhttp3/Cache$c;-><init>(Lokhttp3/y;)V
    ...
    .line 5086
    iget-object v3, p1, Lokhttp3/y;->a:Lokhttp3/Request;
    ...
    invoke-virtual {v2, v3}, Lokhttp3/internal/cache/DiskLruCache;->edit(Ljava/lang/String;)Lokhttp3/internal/cache/DiskLruCache$a;
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0
    ...
    .line 250
    :try_start_2
    invoke-virtual {v1, v2}, Lokhttp3/Cache$c;->a(Lokhttp3/internal/cache/DiskLruCache$a;)V

    .line 251
    new-instance v1, Lokhttp3/Cache$a;

    invoke-direct {v1, p0, v2}, Lokhttp3/Cache$a;-><init>(Lokhttp3/Cache;Lokhttp3/internal/cache/DiskLruCache$a;)V
    :try_end_2
    ...
    :goto_1
    invoke-direct {p0, v1}, Lokhttp3/Cache;->abortQuietly(Lokhttp3/internal/cache/DiskLruCache$a;)V
...
.method final declared-synchronized trackResponse(Lokhttp3/internal/cache/b;)V
    ...
    :cond_1
    :try_start_1
    iget-object v0, p1, Lokhttp3/internal/cache/b;->b:Lokhttp3/y;
...
.method final update(Lokhttp3/y;Lokhttp3/y;)V
    ...
    invoke-direct {v1, p2}, Lokhttp3/Cache$c;-><init>(Lokhttp3/y;)V
    ...
    iget-object v2, v0, Lokhttp3/Cache$b;->a:Lokhttp3/internal/cache/DiskLruCache$c;
    ...
    .line 267
    :try_start_0
    invoke-virtual {v2}, Lokhttp3/internal/cache/DiskLruCache$c;->a()Lokhttp3/internal/cache/DiskLruCache$a;
    ...
    .line 269
    invoke-virtual {v1, v0}, Lokhttp3/Cache$c;->a(Lokhttp3/internal/cache/DiskLruCache$a;)V
    ...
    invoke-direct {p0, v0}, Lokhttp3/Cache;->abortQuietly(Lokhttp3/internal/cache/DiskLruCache$a;)V
