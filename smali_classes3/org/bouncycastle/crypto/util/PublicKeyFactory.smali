...
.method public static createKey(Lorg/bouncycastle/asn1/x509/SubjectPublicKeyInfo;)Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;
    ...
    invoke-virtual {v2}, Lorg/bouncycastle/asn1/x509/RSAPublicKeyStructure;->a()Ljava/math/BigInteger;

    move-result-object v3

    invoke-virtual {v2}, Lorg/bouncycastle/asn1/x509/RSAPublicKeyStructure;->b()Ljava/math/BigInteger;
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/asn1/x9/DHDomainParameters;->a()Lorg/bouncycastle/asn1/DERInteger;
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/asn1/x9/DHDomainParameters;->b()Lorg/bouncycastle/asn1/DERInteger;
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/asn1/x9/DHDomainParameters;->c()Lorg/bouncycastle/asn1/DERInteger;
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/asn1/x9/DHDomainParameters;->d()Lorg/bouncycastle/asn1/DERInteger;
    ...
    :goto_1
    invoke-virtual {v0}, Lorg/bouncycastle/asn1/x9/DHDomainParameters;->e()Lorg/bouncycastle/asn1/x9/DHValidationParms;

    move-result-object v0

    if-eqz v0, :cond_2

    invoke-virtual {v0}, Lorg/bouncycastle/asn1/x9/DHValidationParms;->a()Lorg/bouncycastle/asn1/DERBitString;

    move-result-object v5

    invoke-virtual {v5}, Lorg/bouncycastle/asn1/DERBitString;->b()[B

    move-result-object v6

    invoke-virtual {v0}, Lorg/bouncycastle/asn1/x9/DHValidationParms;->b()Lorg/bouncycastle/asn1/DERInteger;
    ...
    invoke-virtual {v2}, Lorg/bouncycastle/asn1/pkcs/DHParameter;->c()Ljava/math/BigInteger;
    ...
    invoke-virtual {v2}, Lorg/bouncycastle/asn1/pkcs/DHParameter;->a()Ljava/math/BigInteger;

    move-result-object v4

    invoke-virtual {v2}, Lorg/bouncycastle/asn1/pkcs/DHParameter;->b()Ljava/math/BigInteger;
    ...
    invoke-virtual {v2}, Lorg/bouncycastle/asn1/oiw/ElGamalParameter;->a()Ljava/math/BigInteger;

    move-result-object v4

    invoke-virtual {v2}, Lorg/bouncycastle/asn1/oiw/ElGamalParameter;->b()Ljava/math/BigInteger;
    ...
    invoke-virtual {v1}, Lorg/bouncycastle/asn1/x9/X962Parameters;->a()Z

    move-result v0

    if-eqz v0, :cond_a

    invoke-virtual {v1}, Lorg/bouncycastle/asn1/x9/X962Parameters;->c()Lorg/bouncycastle/asn1/DERObject;
    ...
    invoke-virtual {v5}, Lorg/bouncycastle/asn1/x9/X9ECParameters;->a()Lorg/bouncycastle/math/ec/ECCurve;

    move-result-object v1

    invoke-virtual {v5}, Lorg/bouncycastle/asn1/x9/X9ECParameters;->b()Lorg/bouncycastle/math/ec/ECPoint;

    move-result-object v2

    invoke-virtual {v5}, Lorg/bouncycastle/asn1/x9/X9ECParameters;->c()Ljava/math/BigInteger;

    move-result-object v3

    invoke-virtual {v5}, Lorg/bouncycastle/asn1/x9/X9ECParameters;->d()Ljava/math/BigInteger;

    move-result-object v4

    invoke-virtual {v5}, Lorg/bouncycastle/asn1/x9/X9ECParameters;->e()[B
    ...
    invoke-virtual {v3}, Lorg/bouncycastle/asn1/x9/X9ECPoint;->a()Lorg/bouncycastle/math/ec/ECPoint;
