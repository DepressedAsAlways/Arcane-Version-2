...
.field private c:Lkik/android/chat/vm/bb;
...
.method private a(Lkik/android/chat/vm/bb;)V
    .locals 0
    ...
    .line 110
    iput-object p1, p0, Lkik/android/widget/CirclePopupMenuImageView;->c:Lkik/android/chat/vm/bb;
...
.method static synthetic a(Lkik/android/widget/CirclePopupMenuImageView;)V
    ...
    .prologue
    .line 75
    iget-object v0, p0, Lkik/android/widget/CirclePopupMenuImageView;->c:Lkik/android/chat/vm/bb;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lkik/android/widget/CirclePopupMenuImageView;->c:Lkik/android/chat/vm/bb;

    invoke-interface {v0}, Lkik/android/chat/vm/bb;->aj_()Lrx/d;
    ...
    iget-object v1, p0, Lkik/android/widget/CirclePopupMenuImageView;->c:Lkik/android/chat/vm/bb;

    invoke-interface {v1}, Lkik/android/chat/vm/bb;->aj_()Lrx/d;
...
.method public static a(Lkik/android/widget/CirclePopupMenuImageView;Lkik/android/chat/vm/bb;)V
    .locals 0
    ...
    .prologue
    .line 31
    invoke-direct {p0, p1}, Lkik/android/widget/CirclePopupMenuImageView;->a(Lkik/android/chat/vm/bb;)V

    .line 32
    return-void
.end method

.method static synthetic a(Lkik/android/widget/CirclePopupMenuImageView;Lkik/android/chat/vm/cy;)V
    .locals 7
    ...
    .line 82
    invoke-virtual {p1}, Lkik/android/chat/vm/cy;->a()Ljava/util/List;
    ...
    invoke-interface {v0}, Lkik/android/chat/vm/bb;->ak_()V
    ...
    invoke-static {p1}, Lkik/android/widget/u;->a(Lkik/android/chat/vm/cy;)Landroid/widget/PopupMenu$OnMenuItemClickListener;
    ...
    invoke-static {v0}, Lkik/android/widget/v;->a(Landroid/widget/PopupMenu;)Ljava/lang/Runnable;
...
.method public static a(Lkik/android/widget/CirclePopupMenuImageView;Lkik/android/chat/vm/messaging/do;)V
    .locals 0
    .annotation build Landroid/databinding/BindingAdapter;
        value = {
            "model"
...
.method static synthetic a(Lkik/android/chat/vm/cy;Landroid/view/MenuItem;)Z
    .locals 1
    ...
    invoke-virtual {p0, v0}, Lkik/android/chat/vm/cy;->a(I)Z
...
.method static synthetic b(Lkik/android/widget/CirclePopupMenuImageView;)V
    ...
    invoke-interface {v0}, Lkik/android/chat/vm/bb;->f()V
